    ...
    docInfo && (
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            ...
            <div className="flex items-center gap-2 text-sm mt-1 text-gray-600">
              {docInfo.degree} - {docInfo.speciality} <br />
              <button className="py-0.5 px-2 border text-xs rounded-full">{docInfo.experience}</button>
            </div>
            <div>
              <p className="flex items-center gap-3 text-sm font-medium text-gray-900 mt-3">
            ...
            <p>
              ...
              <span>
                {currencySymbol}
                {/* ✅ FIX: backend sends fee not fees */}
                {docInfo.fee}
              </span>
            </p>
          </div>
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
          <p>Booking slots</p>
          <div className="flex flex-row gap-3 items-center overflow-x-scroll mt-4">
            {docSlots.length &&
